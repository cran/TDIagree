...
#' @param y continuous measurement column name.
...
#'            Default is \code{NA}.
#' @param method name of the method(s) to estimate the TDI and UB. Options:
...
#' @param p a value or vector of the proportions for estimation of the TDI, where \eqn{0<p<1}. Commonly, \eqn{p\geq 0.80}. \cr
#'          Default is 0.90.
